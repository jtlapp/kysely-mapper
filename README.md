...
| `columns` | (columns-to-insert array) =><br/> column-restricted insert query (compilable) | (columns-to-update array) =><br/> column-restricted update query (compilable) | N/A | N/A |
